...
export class StrataWeb extends WebPlugin implements StrataPlugin, StrataPlatformAdapter {
  ...
  private handleTouchEnd = (e: TouchEvent): void => {
    ...
    // (TouchEvent objects may be reused by the browser after the event handler completes)
  ...
  async getInputSnapshot(): Promise<InputSnapshot> {
    ...
    if (gamepad) {
      ...
      // Use nullish coalescing to ensure boolean values (gamepad.buttons[n]?.pressed can be undefined)
