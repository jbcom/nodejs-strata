...
describe('createGuardPreset', () => {
    it('should create guard preset with patrol waypoints', () => {
        const config: GuardPresetConfig = {
            patrolWaypoints: [
                [0, 0, 0],
                [10, 0, 0],
                [10, 0, 10],
