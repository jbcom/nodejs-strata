...
export class InputManager {
    ...
    private emit(type: InputEvent['type'], axis: InputAxis, force: number, worldPosition: THREE.Vector3): void {
    ...
    private pollGamepad(): void {
        ...
        const axisChanged = this.gamepadState.axes.some((a, i) => 
            Math.abs(a - prevAxes[i]) > 0.01
        );
