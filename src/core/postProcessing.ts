    ...
    return {
        ...
        bloom:
            presetA.bloom || presetB.bloom
                ...
                : undefined,
        dof:
            presetA.dof || presetB.dof
                ? {
                      focusDistance: blend(
                          presetA.dof?.focusDistance,
                          presetB.dof?.focusDistance,
                          5
                      ),
        ...
        chromaticAberration:
            presetA.chromaticAberration || presetB.chromaticAberration
                ...
                : undefined,
        ssao:
            presetA.ssao || presetB.ssao
                ? {
                      intensity: blend(presetA.ssao?.intensity, presetB.ssao?.intensity, 1),
                      radius: blend(presetA.ssao?.radius, presetB.ssao?.radius, 0.1),
                      luminanceInfluence: blend(
                          presetA.ssao?.luminanceInfluence,
                          presetB.ssao?.luminanceInfluence,
                          0.7
                      ),
                  }
                : undefined,
        toneMapping:
            presetA.toneMapping || presetB.toneMapping
                ? {
                      mode:
                          clampedT < 0.5
                      ...
                      exposure: blend(
                          presetA.toneMapping?.exposure,
                          presetB.toneMapping?.exposure,
                          1
                      ),
                      whitePoint: blend(
                          presetA.toneMapping?.whitePoint,
                          presetB.toneMapping?.whitePoint,
                          4
                      ),
                  }
                : undefined,
        brightnessContrast:
            presetA.brightnessContrast || presetB.brightnessContrast
                ? {
                      brightness: blend(
                          presetA.brightnessContrast?.brightness,
                          presetB.brightnessContrast?.brightness,
                          0
                      ),
                      contrast: blend(
                          presetA.brightnessContrast?.contrast,
                          presetB.brightnessContrast?.contrast,
                          0
                      ),
                  }
                : undefined,
        sepia:
            presetA.sepia || presetB.sepia
                ? {
